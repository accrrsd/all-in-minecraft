...
-- todo first check how p-numeric work in mineshaft, then return heightMode, (revert git commit), it need for get proper distance to block (up or down)
